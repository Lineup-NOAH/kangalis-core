...
Write-Host "    (model ~5 GB indirilip imaja gömülür; ilk derleme bağlantıya göre dakikalar sürebilir)"
...
Write-Host "    Kullanim: docker compose -f docker-compose.yml -f docker-compose.ai-baked.yml --profile ai up -d llamacpp"
